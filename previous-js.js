// // solution by watching session project video
...
//     //comment- console.log(jobName,position,salary,statusBtn,description);
...
//                      <h2 id="" class="company-name mt-6 font-semibold text-[18px]">${rejectedList[i].jobName}</h2>

//                      <p id="" class="position text-[16px] text-[#64748B] mt-1">${rejectedList[i].position}</p>
...
//                       <div><button id="not-applied-btn" class="status-btn btn font-medium bg-[#EEF4FF] text-[14px] rounded-[4px]">${rejectedList[i].statusBtn}</button></div>
